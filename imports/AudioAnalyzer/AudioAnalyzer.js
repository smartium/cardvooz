  ...
  start(callback) {
    navigator.getUserMedia(
      ...
      (stream) => {
        ...
        // AUDIO PEAK METER
        var meterElement = document.getElementById('peakMeter');
        var meterNode = peakMeter.createMeterNode(this.source, audioCtx);
        peakMeter.createMeter(meterElement, meterNode, {
          borderSize: 0,
          fontSize: 0,
          dbRange: 48,
          maskTransition: '0.5s',
